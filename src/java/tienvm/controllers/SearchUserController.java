...
public class SearchUserController extends HttpServlet {
    ...
    private static final String SEARCH = "LoadUserController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<UserDTO> list = dao.findUserByName(search);
            ...
            if(list != null){
                ...
                url = SEARCH;
                session.setAttribute("SEARCH_USERFAIL", "No user searching!");
            }
        } catch (Exception e) {
